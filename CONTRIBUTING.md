...
API layer or view-model architecture described in
[docs/DEVELOPMENT.md](docs/DEVELOPMENT.md).

## Making a change

1. Fork the repo and branch from `master`.
2. See [docs/DEVELOPMENT.md](docs/DEVELOPMENT.md#building-and-running) for
   the build/test commands - the same `dotnet build` / `dotnet test` steps
